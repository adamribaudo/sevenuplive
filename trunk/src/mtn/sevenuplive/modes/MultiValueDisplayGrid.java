		...
		for (int x = 0; x<grid_width-1;x++)
		{
			for (int y = 0; y<grid_height;y++)
			{
				...
				case 0:
					...
					break;
				case 3:  
					if(monome.getValue(x+start_column, y+start_row) != 1)
						monome.setValue(x+start_column, y+start_row, 1);

					break;

				case 2:   
					if(monome.getValue(x+start_column, y+start_row) != 2)
	...
	protected void drawNav() {
		...
		for (int y = 0; y<grid_height;y++)
		{
			...
			case 0:
				...
				break;
			case 3:  
				if(monome.getValue(NAVCOL+start_column, y+start_row) != 1)
					monome.setValue(NAVCOL+start_column, y+start_row, 1);
				break;

			case 2:   
				if(monome.getValue(NAVCOL+start_column, y+start_row) != 2)
